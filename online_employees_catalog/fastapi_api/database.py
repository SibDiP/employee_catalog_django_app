...
# ! Не используется, описал БД
# # MetaData для работы с существующей схемой БД: позволяет "отразить" уже
# # существующие таблицы. На момент создания — пуст, наполнится после описания модели SQLAlchemy.
# metadata = MetaData()
